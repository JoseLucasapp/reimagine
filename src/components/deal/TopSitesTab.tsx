      ...
      <div>
        ...
        <div className="mt-4 glass-card-static" style={{ padding: 0, borderRadius: 12, overflow: "hidden" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4" style={{ padding: "0 24px 24px" }}>
            ...
            {onOpenMap && (
              <ToolCard icon={<Route className="w-6 h-6" style={{ color: "var(--text-muted)" }} />} title="Build Itinerary" description="Review the full map with routing context" onClick={onOpenMap} />
            )}
          </div>
        </div>
